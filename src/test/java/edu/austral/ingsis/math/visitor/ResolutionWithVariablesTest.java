...
public class ResolutionWithVariablesTest {
  ...
  public void shouldResolveFunction3() {
    ...
    final Double result =
        visitor.visit(
            new Multiplication(new Division(new Valor(9), new Variable("x")), new Variable("y")));
  ...
  public void shouldResolveFunction4() {
    ...
    final Double result =
        visitor.visit(new Power(new Division(new Valor(27), new Variable("a")), new Variable("b")));
  ...
  public void shouldResolveFunction5() {
    ...
    final Double result =
        visitor.visit(new Power(new Variable("z"), new Division(new Valor(1), new Valor(2))));
  ...
  public void shouldResolveFunction7() {
    ...
    final Double result =
        visitor.visit(new Resta(new Absolute(new Variable("value")), new Valor(8)));
  ...
  public void shouldResolveFunction8() {
    ...
    final double result =
        visitor.visit(new Multiplication(new Resta(new Valor(5), new Variable("i")), new Valor(8)));
